        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://gmtec.tec.br');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://rmm.gmtec.tec.br');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
              ...
              Container(
                decoration: const BoxDecoration(color: Color(0xFF00B37E)),
                padding:
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            '© ${DateTime.now().toString().substring(0, 4)} GMTec · Nexus Remoto\n$license',
