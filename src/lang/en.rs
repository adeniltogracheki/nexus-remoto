...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Nexus Remoto network..."),
        ...
        ("Slogan_tip", "Secure remote access, managed by Nexus RMM."),
        ...
        ("install_tip", "Due to UAC, Nexus Remoto can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Nexus Remoto to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Nexus Remoto \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Nexus Remoto \"Screen Recording\" permissions."),
        ...
        ("configured_own_server_tip", "Connected to Nexus RMM server"),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Nexus Remoto to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Nexus Remoto Input] service."),
        ...
        ("doc_mac_permission", "https://gmtec.tec.br/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Nexus Remoto application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Nexus Remoto \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Nexus Remoto \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Nexus Remoto."),
        ...
        ("verify_rustdesk_password_tip", "Verify Nexus Remoto password"),
        ("About RustDesk", "About Nexus Remoto"),
        ("Keep RustDesk background service", "Keep Nexus Remoto background service"),
        ("Show RustDesk", "Show Nexus Remoto"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Nexus Remoto and start the service, do not proceed and hang up immediately."),
        ...
        ("doc_fix_wayland", "https://gmtec.tec.br/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Nexus Remoto from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Nexus Remoto window is open"),
        ...
        ("floating_window_tip", "It helps to keep Nexus Remoto background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Nexus Remoto client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Nexus Remoto verifies the server certificate for protocols using TLS.\nWith this option enabled, Nexus Remoto will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Nexus Remoto will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Nexus Remoto server OSS doesn't include this feature."),
