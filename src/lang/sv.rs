...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Nexus Remoto..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Nexus Remoto fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera Nexus Remoto på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge Nexus Remoto \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Nexus Remoto \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Nexus Remoto Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep RustDesk background service", "Behåll Nexus Remoto i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Nexus Remoto programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show RustDesk", "Visa Nexus Remoto"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge Nexus Remoto behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge Nexus Remoto behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för Nexus Remoto."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera Nexus Remoto-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda Nexus Remoto och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra Nexus Remoto från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om Nexus Remoto-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla Nexus Remoto-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera Nexus Remoto-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar Nexus Remoto serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar Nexus Remoto över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder Nexus Remoto inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: Nexus Remoto server OSS inkluderar inte denna funktion."),
