...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie Nexus Remoto tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti Nexus Remoto netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte Nexus Remoto į savo kompiuterį."),
        ("Click to upgrade", "Spustelėkite, jei norite atnaujinti"),
        ("Configure", "Konfigūruoti"),
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti Nexus Remoto \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti Nexus Remoto leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad Nexus Remoto startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti Nexus Remoto naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"Nexus Remoto įvestis\" paslaugą."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep RustDesk background service", "Palikti Nexus Remoto fonine paslauga"),
        ...
        ("Show RustDesk", "Rodyti Nexus Remoto"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti Nexus Remoto leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti Nexus Remoto leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant Nexus Remoto UAC lange paspaustų \"OK\"."),
        ...
        ("verify_rustdesk_password_tip", "Įveskite kliento Nexus Remoto slaptažodį"),
        ...
        ("scam_text1", "Jei kalbatės telefonu su žmogumi, kurio NEPAŽĮSTATE ir kuriuo NEPASITIKITE, ir jis paprašė jūsų naudoti Nexus Remoto bei paleisti paslaugą, netęskite ir nedelsdami padėkite ragelį."),
        ...
        ("selinux_tip", "Jūsų įrenginyje įjungtas SELinux, kuris gali trukdyti Nexus Remoto tinkamai veikti kaip valdomajai pusei."),
        ...
        ("powered_by_me", "Veikia su Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Leisti prisijungti tik tada, kai atidarytas Nexus Remoto langas"),
        ...
        ("floating_window_tip", "Tai padeda išlaikyti Nexus Remoto foninę paslaugą"),
        ...
        ("About RustDesk", "Apie Nexus Remoto"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės Nexus Remoto klientą į {} ar naujesnę versiją!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pagal numatytuosius nustatymus Nexus Remoto tikrina serverio sertifikatą protokoluose, naudojančiuose TLS.\nĮgalinus šią parinktį, patikros nesėkmės atveju Nexus Remoto praleis patikros veiksmą ir tęs darbą."),
        ("Disable UDP", "Išjungti UDP"),
        ("disable-udp-tip", "Nurodo, ar naudoti tik TCP.\nĮgalinus šią parinktį, Nexus Remoto nebenaudos UDP 21116, vietoj jo bus naudojamas TCP 21116."),
        ("server-oss-not-support-tip", "PASTABA: Nexus Remoto serverio OSS šios funkcijos neturi."),
