...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red Nexus Remoto en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que Nexus Remoto no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar Nexus Remoto a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Nexus Remoto de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Nexus Remoto de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que Nexus Remoto use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [Nexus Remoto Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Dejar Nexus Remoto como Servicio en 2do plano"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a Nexus Remoto permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a Nexus Remoto permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de Nexus Remoto"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses Nexus Remoto e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que Nexus Remoto no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de Nexus Remoto"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de Nexus Remoto de fondo"),
        ...
        ("About RustDesk", "Acerca de Nexus Remoto"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente Nexus Remoto a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, Nexus Remoto verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, Nexus Remoto volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, Nexus Remoto no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor Nexus Remoto OSS no incluye esta característica."),
