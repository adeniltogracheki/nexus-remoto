...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Nexus Remoto..."),
        ...
        ("install_tip", "Do cơ chế UAC, Nexus Remoto có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt Nexus Remoto vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho Nexus Remoto."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho Nexus Remoto."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [Nexus Remoto Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep RustDesk background service", "Giữ dịch vụ Nexus Remoto chạy nền"),
        ...
        ("Show RustDesk", "Hiện Nexus Remoto"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Nexus Remoto"),
        ...
        ("scam_text2", "Chỉ sử dụng Nexus Remoto với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ Nexus Remoto mở"),
        ...
        ("floating_window_tip", "Giữ Nexus Remoto trên cùng"),
        ...
        ("About RustDesk", "Về Nexus Remoto"),
