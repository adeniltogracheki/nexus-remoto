...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do Nexus Remoto..."),
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "Acesso remoto seguro, gerido pelo Nexus RMM."),
        ...
        ("install_tip", "Devido ao UAC, o Nexus Remoto não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Nexus Remoto no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao Nexus Remoto permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao Nexus Remoto permissões de \"Gravar a Tela\"/"),
        ...
        ("configured_own_server_tip", "Ligado ao servidor Nexus RMM"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o Nexus Remoto use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [Nexus Remoto Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep RustDesk background service", "Manter o serviço Nexus Remoto em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação Nexus Remoto, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show RustDesk", "Mostrar Nexus Remoto"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao Nexus Remoto as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao Nexus Remoto as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do Nexus Remoto em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do Nexus Remoto"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o Nexus Remoto e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o Nexus Remoto de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do Nexus Remoto estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do Nexus Remoto"),
        ...
        ("About RustDesk", "Sobre o Nexus Remoto"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente Nexus Remoto para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o Nexus Remoto verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o Nexus Remoto recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o Nexus Remoto deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o Nexus Remoto server OSS não inclui esta funcionalidade."),
