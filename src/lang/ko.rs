...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비 완료"),
        ("Established", "연결됨"),
        ("connecting_status", "Nexus Remoto 네트워크에 연결 중..."),
        ...
        ("OS Password", "OS 비밀번호"),
        ("install_tip", "UAC로 인해 경우에 따라 Nexus Remoto가 원격 쪽에서 제대로 작동하지 않을 수 있습니다. UAC를 피하려면 아래 버튼을 클릭하여 시스템에 Nexus Remoto를 설치하세요."),
        ("Click to upgrade", "업그레이드"),
        ("Configure", "구성"),
        ("config_acc", "데스크탑을 원격으로 제어하려면 Nexus Remoto에 \"접근성\" 권한을 부여해야 합니다."),
        ("config_screen", "데스크탑에 원격으로 액세스하려면 Nexus Remoto에 \"화면 녹화\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치 중..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("android_input_permission_tip1", "원격 장치에서 마우스나 터치로 Android 장치를 제어하려면 Nexus Remoto가 \"접근성\" 서비스를 사용하도록 허용해야 합니다."),
        ("android_input_permission_tip2", "다음 시스템 설정 페이지로 이동하여 [설치된 서비스]를 찾아 들어가서 [Nexus Remoto 입력] 서비스를 켜세요."),
        ...
        ("Turned off", "꺼짐"),
        ("Language", "언어"),
        ("Keep RustDesk background service", "Nexus Remoto 백그라운드 서비스 유지"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시"),
        ("android_open_battery_optimizations_tip", "이 기능을 비활성화하려면 다음 Nexus Remoto 응용 프로그램 설정 페이지로 이동하여 [배터리]를 찾아서 입력하고 [제한 없음]을 선택 취소하세요"),
        ...
        ("config_input", "키보드로 원격 데스크탑을 제어하려면 Nexus Remoto에 \"입력 모니터링\" 권한을 부여해야 합니다."),
        ("config_microphone", "원격으로 통화하려면 Nexus Remoto에 \"오디오 녹음\" 권한을 부여해야 합니다."),
        ...
        ("still_click_uac_tip", "여전히 원격 사용자가 Nexus Remoto를 실행하는 UAC 창에서 확인을 클릭해야 합니다."),
        ...
        ("verify_rustdesk_password_tip", "Nexus Remoto 비밀번호 확인"),
        ...
        ("scam_text1", "알지 못하고 신뢰할 수 없는 사람이 전화를 걸어 Nexus Remoto를 사용하고 서비스를 시작하라고 요청하는 경우 계속 진행하지 말고 즉시 전화를 끊으세요."),
        ...
        ("selinux_tip", "SELinux가 장치에서 활성화되어 있어 Nexus Remoto가 제어된 상태로 제대로 작동하지 않을 수 있습니다."),
        ("Change view", "보기 변경"),
        ("Big tiles", "큰 타일"),
        ("Small tiles", "작은 타일"),
        ("List", "목록"),
        ...
        ("allow-only-conn-window-open-tip", "Nexus Remoto 창이 열려 있을 때만 연결 허용"),
        ...
        ("floating_window_tip", "Nexus Remoto 백그라운드 서비스를 유지하는 데 도움이 됩니다"),
        ...
        ("About RustDesk", "Nexus Remoto 정보"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Nexus Remoto 클라이언트를 원격 버전 {} 이상으로 업그레이드해 주세요!"),
        ...
        ("allow-insecure-tls-fallback-tip", "기본적으로 Nexus Remoto는 TLS를 사용하여 프로토콜에 대한 서버 인증서를 검증합니다.\n이 옵션을 활성화하면 Nexus Remoto는 인증 단계를 건너뛰고 인증 실패 시 진행합니다."),
        ("Disable UDP", "UDP 사용 안 함"),
        ("disable-udp-tip", "TCP만 사용할지 여부를 제어합니다.\n이 옵션을 활성화하면 Nexus Remoto는 더 이상 UDP 2116을 사용하지 않고 대신 TCP 2116을 사용합니다."),
        ("server-oss-not-support-tip", "참고: Nexus Remoto 서버 OSS에는 이 기능이 포함되어 있지 않습니다."),
