...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο Nexus Remoto..."),
        ...
        ("install_tip", "Λόγω UAC, το Nexus Remoto ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το Nexus Remoto στο σύστημα"),
        ("Click to upgrade", "Κάντε κλίκ για αναβάθμιση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για να ελέγξετε την επιφάνεια εργασίας σας από απόσταση, πρέπει να παραχωρήσετε στο Nexus Remoto το δικαίωμα της \"Προσβασιμότητας\"."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στην επιφάνεια εργασίας σας, πρέπει να παραχωρήσετε στο Nexus Remoto το δικαίωμα της \"Εγγραφή οθόνης\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο Nexus Remoto να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλούμε να μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος Nexus Remoto]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep RustDesk background service", "Διατήρηση της υπηρεσίας παρασκηνίου του Nexus Remoto"),
        ...
        ("Show RustDesk", "Εμφάνιση του Nexus Remoto"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με το πληκτρολόγιο, πρέπει να παραχωρήσετε στο Nexus Remoto το δικαίωμα της \"Παρακολούθηση εισόδου\"."),
        ("config_microphone", "Για να μιλήσετε εξ αποστάσεως, πρέπει να παραχωρήσετε στο Nexus Remoto το δικαίωμα της \"Εγγραφή ήχου\"."),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο πλήκτρο Εντάξει στο παράθυρο UAC όπου εκτελείται το Nexus Remoto."),
        ...
        ("verify_rustdesk_password_tip", "Επιβεβαιώστε τον κωδικό του Nexus Remoto"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το Nexus Remoto, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("selinux_tip", "Το SELinux είναι ενεργοποιημένο στη συσκευή σας, κάτι που ενδέχεται να εμποδίσει την σωστή λειτουργία του Nexus Remoto ως ελεγχόμενης πλευράς."),
        ...
        ("powered_by_me", "Με την υποστήριξη του Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο Nexus Remoto είναι ανοιχτό"),
        ...
        ("floating_window_tip", "Βοηθά στη διατήρηση της υπηρεσίας παρασκηνίου Nexus Remoto"),
        ("Keep screen on", "Διατήρηση οθόνης Ανοιχτή"),
        ("Never", "Ποτέ"),
        ("During controlled", "Κατα την διάρκεια απομακρυσμένου ελέγχου"),
        ("During service is on", "Κατα την εκκίνηση της υπηρεσίας Nexus Remoto"),
        ...
        ("About RustDesk", "Πληροφορίες για το Nexus Remoto"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη Nexus Remoto στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Από προεπιλογή, το Nexus Remoto επαληθεύει το πιστοποιητικό διακομιστή για πρωτόκολλα που χρησιμοποιούν TLS.\nΜε ενεργοποιημένη αυτήν την επιλογή, το Nexus Remoto θα παρακάμψει το βήμα επαλήθευσης και θα προχωρήσει σε περίπτωση αποτυχίας επαλήθευσης."),
        ("Disable UDP", "Απενεργοποίηση UDP"),
        ("disable-udp-tip", "Ελέγχει εάν θα χρησιμοποιείται μόνο TCP.\nΌταν είναι ενεργοποιημένη αυτή η επιλογή, το Nexus Remoto δεν θα χρησιμοποιεί πλέον το UDP 21116, αλλά θα χρησιμοποιείται το TCP 21116."),
        ("server-oss-not-support-tip", "ΣΗΜΕΙΩΣΗ: Το OSS του διακομιστή Nexus Remoto δεν περιλαμβάνει αυτήν τη λειτουργία."),
