...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Nexus Remoto..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Nexus Remoto v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate Nexus Remotou dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate Nexus Remotou dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno Nexus Remotou dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Nexus Remoto Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep RustDesk background service", "Ohrani Nexus Remotoovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Nexus Remoto, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "Nexus Remoto potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "Nexus Remoto potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za Nexus Remoto"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite Nexus Remoto, prekinite klic in program zaprite."),
        ("scam_text2", "Nexus Remoto omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("powered_by_me", "Uporablja tehnologijo Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno Nexus Remotoa odprto"),
        ...
        ("floating_window_tip", "Pomaga pri Nexus Remoto storitvi v ozadju"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite Nexus Remoto odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto Nexus Remoto preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo Nexus Remoto ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, Nexus Remoto ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik Nexus Remoto OSS ne vključuje te funkcije."),
