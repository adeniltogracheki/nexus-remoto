...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Për shkak të UAC, Nexus Remoto nuk mund të punoj sic duhet si nje remote në distancë në disa raste. Për të shamngur UAC, ju lutem klikoni butonin më poshtë për të instaluar Nexus Remoto në sistem."),
        ("Click to upgrade", "Klikoni për përmirësim"),
        ("Configure", "Koniguro"),
        ("config_acc", "Për të kontrolluar Desktopin tuaj nga distanca, duhet të jepni leje Nexus Remoto \"Aksesueshmëri\"."),
        ("config_screen", "Për të aksesuar Desktopin tuaj nga distanca, duhet ti jepni lejet Nexus Remoto \"Regjistrimin e ekranit\"."),
        ...
        ("android_input_permission_tip1", "Në mënyrë që një pajisje në distancë të kontrollojë pajisjen tuaj Android nëpërmjet mausit ose prekjes, duhet të lejoni Nexus Remoto të përdorë shërbimin."),
        ("android_input_permission_tip2", "Ju lutemi shkoni në faqen tjetër të cilësimeve të sistemit, gjeni dhe shtypni [Shërbimet e Instaluara], aktivizoni shërbimin [Nexus Remoto Input]"),
        ...
        ("Turned off", "I fikur"),
        ("Language", "Gjuha"),
        ("Keep RustDesk background service", "Mbaje shërbimin e sfondit të Nexus Remoto"),
        ("Ignore Battery Optimizations", "Injoro optimizimet e baterisë"),
        ("android_open_battery_optimizations_tip", "Nëse dëshironi ta çaktivizoni këtë veçori, ju lutemi shkoni te faqja tjetër e cilësimeve të aplikacionit Nexus Remoto, gjeni dhe shtypni [Batteri], hiqni zgjedhjen [Te pakufizuara]"),
        ...
        ("Show RustDesk", "Shfaq Nexus Remoto"),
        ("This PC", "Ky PC"),
        ("or", "ose"),
        ("Elevate", "Ngritja"),
        ...
        ("config_input", "Për të kontrolluar desktopin në distancë me tastierë, duhet t'i jepni Nexus Remoto lejen \"Monitorimi i hyrjes\"."),
        ("config_microphone", "Për të folur në distancë, duhet t'i jepni Nexus Remoto lejen \"Regjistro audio\"."),
        ...
        ("still_click_uac_tip", "Ende kërkon që përdoruesi në distancë të klikojë OK në dritaren UAC të Nexus Remoto që po funksionon."),
        ...
        ("verify_rustdesk_password_tip", "Verifiko fjalëkalimin e Nexus Remoto"),
        ...
        ("scam_text1", "Nëse jeni në telefon me dikë që NUK e njihni DHE NUK i BESONI, i cili ju ka kërkuar të përdorni Nexus Remoto dhe të nisni shërbimin, mos vazhdoni dhe mbyllni telefonin menjëherë."),
        ...
        ("selinux_tip", "SELinux është i aktivizuar në pajisjen tuaj, gjë që mund të pengojë Nexus Remoto të funksionojë siç duhet si anë e kontrolluar."),
        ...
        ("powered_by_me", "Mundësuar nga Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Lejo lidhjen vetëm nëse dritarja e Nexus Remoto është e hapur"),
        ...
        ("floating_window_tip", "Ndihmon për të mbajtur shërbimin në sfond të Nexus Remoto"),
        ...
        ("About RustDesk", "Rreth Nexus Remoto"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Ju lutemi përmirësoni klientin Nexus Remoto në versionin {} ose më të ri në anën në distancë!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Si parazgjedhje, Nexus Remoto verifikon certifikatën e serverit për protokollet që përdorin TLS.\nMe këtë opsion të aktivizuar, Nexus Remoto do të kthehet duke kapërcyer hapin e verifikimit dhe do të vazhdojë në rast dështimi të verifikimit."),
        ("Disable UDP", "Çaktivizo UDP"),
        ("disable-udp-tip", "Kontrollon nëse do të përdoret vetëm TCP.\nKur ky opsion është i aktivizuar, Nexus Remoto nuk do ta përdorë më UDP 21116, në vend të tij do të përdoret TCP 21116."),
        ("server-oss-not-support-tip", "SHËNIM: Nexus Remoto server OSS nuk e përfshin këtë veçori."),
