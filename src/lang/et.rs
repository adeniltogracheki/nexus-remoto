...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Nexus Remotoi võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa Nexus Remoto mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et Nexus Remoto oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb Nexus Remotoile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb Nexus Remotoile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma Nexus Remotoile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [Nexus Remoto Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep RustDesk background service", "Säilita Nexus Remotoi taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele Nexus Remotoi rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show RustDesk", "Kuva Nexus Remoto"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma Nexus Remotoile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma Nexus Remotoile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud Nexus Remotoi kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita Nexus Remotoi parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul Nexus Remotoi kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib Nexus Remotoil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb Nexus Remotoil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui Nexus Remotoi aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada Nexus Remotoi taustateenust."),
        ...
        ("About RustDesk", "Nexus Remotoi teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage Nexus Remotoi klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib Nexus Remoto TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab Nexus Remoto kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta Nexus Remoto enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: Nexus Remotoi serveri OSS ei sisalda seda funktsiooni."),
