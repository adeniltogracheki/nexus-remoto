...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में Nexus Remoto खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep RustDesk background service", "Nexus Remoto बैकग्राउंड सेवा चालू रखें"),
        ...
        ("Show RustDesk", "Nexus Remoto दिखाएं"),
        ("This PC", "यह PC"),
        ("or", "या"),
        ...
        ("verify_rustdesk_password_tip", "Nexus Remoto पासवर्ड सत्यापित करें"),
        ...
        ("scam_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे Nexus Remoto उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब Nexus Remoto विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान Nexus Remoto को दिखाएं"),
        ...
        ("About RustDesk", "Nexus Remoto के बारे में"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "रिमोट Nexus Remoto क्लाइंट को संस्करण {} में अपग्रेड करें"),
