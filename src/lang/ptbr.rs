...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do Nexus Remoto..."),
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "Acesso remoto seguro, gerenciado pelo Nexus RMM."),
        ...
        ("install_tip", "Devido ao UAC, o Nexus Remoto não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Nexus Remoto no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao Nexus Remoto permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao Nexus Remoto permissões de \"Gravar a Tela\"/"),
        ...
        ("configured_own_server_tip", "Conectado ao servidor Nexus RMM"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o Nexus Remoto use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [Nexus Remoto Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Manter o serviço do Nexus Remoto executando em segundo plano"),
        ...
        ("Show RustDesk", "Exibir Nexus Remoto"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do Nexus Remoto."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do Nexus Remoto."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do Nexus Remoto."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do Nexus Remoto"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o Nexus Remoto e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o Nexus Remoto funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do Nexus Remoto estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço Nexus Remoto em segundo plano"),
        ...
        ("About RustDesk", "Sobre Nexus Remoto"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente Nexus Remoto para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o Nexus Remoto verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o Nexus Remoto ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o Nexus Remoto não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor Nexus Remoto OSS não inclui este recurso."),
