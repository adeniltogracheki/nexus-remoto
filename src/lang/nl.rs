...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het Nexus Remoto netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer Nexus Remoto op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u Nexus Remoto toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u Nexus Remoto toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u Nexus Remoto toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [Nexus Remoto Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep RustDesk background service", "Nexus Remoto achtergronddienst behouden"),
        ...
        ("Show RustDesk", "Toon Nexus Remoto"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ("Elevate", "Verhoog"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u Nexus Remoto toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u Nexus Remoto toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende Nexus Remoto."),
        ...
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord Nexus Remoto"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om Nexus Remoto te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor Nexus Remoto mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met Nexus Remoto"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het Nexus Remoto-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt Nexus Remoto op de achtergrond actief te houden"),
        ...
        ("About RustDesk", "Over Nexus Remoto"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgrade de Nexus Remoto client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert Nexus Remoto het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat Nexus Remoto verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt Nexus Remoto niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de Nexus Remoto-server."),
