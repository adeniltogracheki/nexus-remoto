...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til Nexus Remoto-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan Nexus Remoto ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere Nexus Remoto på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give Nexus Remoto \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give Nexus Remoto \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give Nexus Remoto mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [Nexus Remoto Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep RustDesk background service", "Behold Nexus Remoto baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn Nexus Remoto appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("Show RustDesk", "Vis Nexus Remoto"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
        ("Elevate", "Elevér"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af Nexus Remoto er nødvendigt."),
        ("Always use software rendering", "Brug altid software rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give Nexus Remoto rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give Nexus Remoto rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af Nexus Remoto."),
        ...
        ("verify_rustdesk_password_tip", "Bekræft Nexus Remoto adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge Nexus Remoto til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre Nexus Remoto i at køre normalt."),
        ...
        ("powered_by_me", "Drives af Nexus Remoto"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af Nexus Remoto med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis Nexus Remoto vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at Nexus Remoto baggrundstjenesten kører"),
        ...
        ("About RustDesk", "Om Nexus Remoto"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Opgrader venligst Nexus Remoto-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer Nexus Remoto servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil Nexus Remoto springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil Nexus Remoto ikke længere bruge UDP 21116; i stedet bruges TCP 21116."),
        ("server-oss-not-support-tip", "BEMÆRK: Nexus Remoto server OSS indeholder ikke denne funktion."),
